...
?>
    <div id="owl-single-product">
        <div class="single-product-gallery-item" id="slide1">
            <a data-lightbox="image-1" data-title="Gallery" href="<?= $mainImg->getUrl(); ?>">
                <?= Html::img("/images/blank.gif", [
                            'data-echo' => $mainImg->getUrl('336x374'), 
                            'alt' => $game["title"],
        ...
        <div class="single-product-gallery-item" id="slide<?= $i; ?>">
            <a data-lightbox="image-1" data-title="Gallery" href="<?= $image->getUrl();?>">
                <img class="img-responsive" alt="" src="<?= $image->getUrl('85x100');?>" data-echo="<?= $image->getUrl();?>" />
            </a>
        </div><!-- /.single-product-gallery-item -->
        <?php $i++; endforeach; ?>
        ...
        <div class="product-info">
                ...
                <div class="quantity-container info-container">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <a href="<?php echo \yii\helpers\Url::to(['cart/add', 'id' => $game->id]); ?>" class="btn btn-primary add-to-cart" data-id="<?= $game['id']; ?>">
