...
<?php echo app\components\MainTopSliderWidget::widget(); ?>
...
<!-- ============================================== SCROLL TABS ============================================== -->
<?php echo app\components\MainNewProductWidget::widget(); ?>
<!-- ============================================== SCROLL TABS : END ============================================== -->

<!-- ============================================== DISCOUNT PRODUCTS ============================================== -->
<?php echo app\components\MainDiscountProductWidget::widget(); ?>	
<!-- ============================================== DISCOUNT PRODUCTS : END ============================================== -->
<!-- ============================================== WIDE PRODUCTS ============================================== -->
<?php echo app\components\MainPreorderWidget::widget(); ?>
<!-- ============================================== WIDE PRODUCTS : END ============================================== -->
<!-- ============================================== BEST SELLER ============================================== -->
<?php echo app\components\MainBestsellerProductWidget::widget(); ?>
<!-- ============================================== BEST SELLER : END ============================================== -->
	</div><!-- /.container -->
